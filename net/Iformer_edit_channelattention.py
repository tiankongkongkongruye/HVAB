...
class BrightnessEqualizer(nn.Module):
    def __init__(self):
        super().__init__()
    ...
    def forward(self, R):
        correction = self.conv2(self.relu(self.conv1(R)))
        output = R + correction  # residual 加法
...
class net(nn.Module):
    def __init__(self):
        ...
        # self.refineNet = BrightnessEqualizer()
