...
parser.add_argument('--data_test', type=str, default='data/20250718/up')
...
parser.add_argument('--model', default='weights/HTIW_CBAM_CSAM_RAG/epoch_100.pth', help='Pretrained base model')  
# parser.add_argument('--model', default='weights/HTIW_CBAM_CSAM_RAG/last_result.pth', help='Pretrained base model')  
parser.add_argument('--output_folder', type=str, default='results/20250718/up')
...
def eval():
    ...
    print(f"Function executed in {elapsed_time:.6f} seconds using time.perf_counter()")
